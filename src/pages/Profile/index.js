...
import { Container, Title, Form, Separator, FormInput, SubmitButton, LogoutButton } from './styles';
    ...
    <Background>
      <Container>
        ...
        <Form>
          ...
          <LogoutButton loading={loading} onPress={handleLogout}>Sair do GoBarber</LogoutButton>
